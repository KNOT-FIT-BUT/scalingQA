...
# Configuration with context size 2, runs on 12GB GPU
config = {
    ...
    "save_threshold": 0.41,  # save up some disk space, nothing with EM under this threshold will be saved
    ...
    "context_length": 2,  # try something small for toy example
